"""
=============================================================
MODULE 5 — STREAMLIT INTERACTIVE DASHBOARD
International Football Analytics Project
=============================================================

Pages:
  Page 1 → Overview & Key Stats
  Page 2 → Team Explorer
  Page 3 → Head-to-Head Analyzer
  Page 4 → Elo Rankings & Timeline
  Page 5 → Match Predictor (ML model live)
  Page 6 → 2026 World Cup Predictions
...
# ─────────────────────────────────────────
# GLOBAL CSS — dark/light mode safe
# ─────────────────────────────────────────
st.markdown("""
<style>
    /* ── Metric cards ── */
...
# ═══════════════════════════════════════════════════════
    ...
    if len(predictions) == 0:
        st.warning("Run `module4_ml.py` first to generate `ml_predictions_2026.csv`.")
        st.stop()
